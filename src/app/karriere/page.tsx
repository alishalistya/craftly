...
export const metadata: Metadata = {
  title: "Karriere – Arbeiten bei Craftly",
  description:
    "Werde Teil des Craftly-Teams. Wir bauen die Lagerverwaltung für das deutsche Handwerk – einfach, kostenlos und mit Herz.",
};
...
export default function KarrierePage() {
  return (
    <>
      <PageHero
        label="Karriere"
        title="Arbeiten bei <span class='text-brand'>Craftly</span>"
          ...
          <div className="max-w-2xl mx-auto text-center">
            <FadeUp>
              ...
              <p className="text-text-muted mb-8">
                Wenn Sie Interesse haben, bei Craftly mitzuwirken &ndash;
            ...
            <FadeUp>
              <div className="bg-surface-subtle rounded-2xl border border-border p-8">
                ...
                <p className="text-sm text-text-muted mb-4">
                  ...
                  &uuml;ber sich und was Sie bei Craftly machen m&ouml;chten.
                </p>
                <a
                  href="mailto:karriere@craftly.de"
